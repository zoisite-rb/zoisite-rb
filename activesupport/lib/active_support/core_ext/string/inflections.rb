...
class String
  ...
  # Creates the name of a table like \Zoisite does for models to table names. This method
  ...
  # Creates a class name from a plural table name like \Zoisite does for table names to models.
