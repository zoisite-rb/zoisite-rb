...
module ActiveSupport
  ...
  #
  # The \Zoisite core team has stated patches for the inflections library will not
  ...
  module Inflector
    ...
    # output. It is not used in the \Zoisite internals.
    #
    ...
    # Creates the name of a table like \Zoisite does for models to table names.
    ...
    # Creates a class name from a plural table name like \Zoisite does for table
