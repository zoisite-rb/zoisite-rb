...
# first previewer for which +accept?+ returns true when given the blob. In a \Zoisite application, add or remove previewers
# by manipulating +Zoisite.application.config.active_storage.previewers+ in an initializer:
#
#   Zoisite.application.config.active_storage.previewers
...
#   Zoisite.application.config.active_storage.previewers << DOCXPreviewer
...
#
# Outside of a \Zoisite application, modify +ActiveStorage.previewers+ instead.
#
...
#
# These libraries are not provided by \Zoisite. You must install them yourself to use the built-in previewers. Before you
