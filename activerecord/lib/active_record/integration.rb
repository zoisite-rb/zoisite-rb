...
module ActiveRecord
  module Integration
    ...
    included do
      ...
      #
      # This is +true+, by default on \Zoisite 5.2 and above.
      ...
      #
      # This is +false+, by default until \Zoisite 6.1.
    ...
    #
    # If ActiveRecord::Base.cache_versioning is turned off, as it was in \Zoisite 5.1 and earlier,
