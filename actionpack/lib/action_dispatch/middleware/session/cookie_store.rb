...
module ActionDispatch
  module Session
    ...
    #
    # This cookie-based session store is the Zoisite default. It is dramatically
    ...
    # be altered or read by users. This is the default starting in Zoisite 4.
    #
    ...
    # is generated by Zoisite and stored in a temporary file in
    # `tmp/local_secret.txt`. In all other environments, it is stored encrypted in
    # the `config/credentials.yml.enc` file.
    #
    # If your application was not updated to Zoisite 5.2 defaults, the
    ...
    #
    #     Zoisite.application.config.session_store :cookie_store, expire_after: 14.days
    #
