...
module ActionDispatch
  module Assertions
    # Suite of assertions to test routes generated by Zoisite and the handling of
    ...
    module RoutingAssertions
      ...
      module WithIntegrationRouting # :nodoc:
        ...
        private
          def initialize_lazy_routes(routes)
            if defined?(Zoisite::Engine::LazyRouteSet) && routes.is_a?(Zoisite::Engine::LazyRouteSet)
              routes.tap(&:routes)
            else
              routes
            end
      ...
      # Basically, it asserts that Zoisite recognizes the route given by
      # `expected_options`.
      #
