...
Gem::Specification.new do |s|
  ...
  s.metadata = {
    ...
    "changelog_uri"     => "https://github.com/zoisite-rb/zoisite-rb/blob/v#{version}/actionview/CHANGELOG.md",
    "documentation_uri" => "https://api.zoisite.org/v#{version}/",
    "mailing_list_uri"  => "https://discuss.zoisite.org/c/zoisite-talk",
    "source_code_uri"   => "https://github.com/zoisite-rb/zoisite-rb/tree/v#{version}/actionview",
