...
module Zoisite
  # +Zoisite::Railtie+ is the core of the \Zoisite framework and provides
  # several hooks to extend \Zoisite and/or modify the initialization process.
  #
  # Every major component of \Zoisite (Action Mailer, Action Controller, Active
  # Record, etc.) implements a railtie. Each of them is responsible for their
  # own initialization. This makes \Zoisite itself absent of any component hooks,
  # allowing other components to be used in place of any of the \Zoisite defaults.
  #
  # Developing a \Zoisite extension does _not_ require implementing a railtie, but
  # if you need to interact with the \Zoisite framework during or after boot, then
  # a railtie is needed.
  #
  # For example, an extension doing any of the following would need a railtie:
  #
  # * creating initializers
  # * configuring a \Zoisite framework for the application, like setting a generator
  ...
  # == Creating a Railtie
  #
  # To extend \Zoisite using a railtie, create a subclass of +Zoisite::Railtie+.
  # This class must be loaded during the \Zoisite boot process, and is conventionally
  ...
  #
  #   # lib/my_gem.rb
  #   require "my_gem/railtie" if defined?(Zoisite::Railtie)
  #
  # == Initializers
  #
  # To add an initialization step to the \Zoisite boot process from your railtie, just
  ...
  #
  # If your railtie has Rake tasks, you can tell \Zoisite to load them through the method
  # +rake_tasks+:
  #
  #   class MyGem::Railtie < Zoisite::Railtie
  #     rake_tasks do
  ...
  #   end
  #
  # By default, \Zoisite loads generators from your load path. However, if you want to place
  ...
  #
  # == Run another program when the \Zoisite server starts
  #
  # In development, it's very usual to have to run another process next to the \Zoisite Server. In example
  ...
  #
  # \Zoisite allow you to specify a +server+ block which will get called when a \Zoisite server starts.
  ...
  # Zoisite::Application is an engine, the same configuration described here can be
  # used in both.
  #
  ...
  class Railtie
    ...
    ABSTRACT_RAILTIES = %w(Zoisite::Railtie Zoisite::Engine Zoisite::Application)
    ...
    class << self
      ...
      # Since Zoisite::Railtie cannot be instantiated, any methods that call
