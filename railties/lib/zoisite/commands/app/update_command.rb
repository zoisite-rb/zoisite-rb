  ...
  module Command
    module App
      class UpdateCommand < Base # :nodoc:
        ...
        def perform
          require_application!
          Zoisite.application.deprecators.silenced = true
        ...
        private
          def display_upgrade_guide_info
            say "\nAfter this, check Zoisite upgrade guide at https://guides.zoisite-rb.org/upgrading_zoisite.html for more details about upgrading your app."
          end
          ...
          def generator_options
            {
              api:                 !!Zoisite.application.config.api_only,
              update:              true,
              name:                Zoisite.application.class.name.chomp("::Application").underscore,
              ...
              skip_test:           !defined?(Zoisite::TestUnitRailtie),
              skip_system_test:    Zoisite.application.config.generators.system_tests.nil?,
