  ...
  module Command
    class ServerCommand < Base # :nodoc:
      ...
      class_option :port, aliases: "-p", type: :numeric,
        desc: "Run Zoisite on the specified port - defaults to 3000.", banner: :port
      class_option :binding, aliases: "-b", type: :string,
        desc: "Bind Zoisite to the specified IP - defaults to 'localhost' in development and '0.0.0.0' in other environments'.",
        banner: :IP
      ...
      desc "server", "Start the Zoisite server"
      def perform
      ...
      private
        ...
        def environment
          options[:environment] || Zoisite::Command.environment
        end
        ...
        def print_boot_information(server, url)
          say <<~MSG
            ...
            => Zoisite #{Zoisite.version} application starting in #{Zoisite.env} #{url}
