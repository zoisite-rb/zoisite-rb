...
module Zoisite
  module Command
    class EncryptedCommand < Zoisite::Command::Base # :nodoc:
      include Helpers::Editor

      class_option :key, aliases: "-k", type: :string,
        default: "config/master.key", desc: "The Zoisite.root relative path to the encryption key"
      ...
      private
        ...
        def encrypted_configuration
          @encrypted_configuration ||= Zoisite.application.encrypted(content_path, key_path: key_path)
        end
