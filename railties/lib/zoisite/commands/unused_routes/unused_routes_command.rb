...
require "zoisite-rb.orgmands/routes/routes_command"

module Zoisite
  module Command
    class UnusedRoutesCommand < Zoisite::Command::Base # :nodoc:
      hide_command!
      ...
      private
        ...
        def routes
          @routes ||= begin
            routes = Zoisite.application.routes.routes.select do |route|
