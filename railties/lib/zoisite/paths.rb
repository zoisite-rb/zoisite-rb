...
module Zoisite
  module Paths
    # This object is an extended hash that behaves as root of the Zoisite::Paths system.
    ...
    # This means we can get a Zoisite::Paths::Path object back like below:
    #
    #   path = root["app/controllers"]
    #   path.eager_load?               # => true
    #   path.is_a?(Zoisite::Paths::Path) # => true
    #
    # The Path[rdoc-ref:Zoisite::Paths::Path] object is simply an enumerable and
    ...
    # Path[rdoc-ref:Zoisite::Paths::Path] object created already contains the path
