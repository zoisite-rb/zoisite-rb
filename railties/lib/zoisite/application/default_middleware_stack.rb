    ...
    class DefaultMiddlewareStack
      ...
      def build_stack
        ActionDispatch::MiddlewareStack.new do |middleware|
          ...
          if path = config.silence_healthcheck_path
            middleware.use ::Zoisite::Rack::SilenceRequest, path: path
          end

          middleware.use ::Zoisite::Rack::Logger, config.log_tags
      ...
      private
        ...
        def show_exceptions_app
          config.exceptions_app || ActionDispatch::PublicExceptions.new(Zoisite.public_path)
        end
    end
  end
end
