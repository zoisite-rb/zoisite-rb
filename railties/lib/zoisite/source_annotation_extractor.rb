...
module Zoisite
  ...
  class SourceAnnotationExtractor
    ...
    class Annotation < Struct.new(:line, :tag, :text)
      ...
      #   Zoisite::SourceAnnotationExtractor::Annotation.register_directories("spec", "another")
      ...
      #   Zoisite::SourceAnnotationExtractor::Annotation.register_tags("TESTME", "DEPRECATEME")
      ...
      #   Zoisite::SourceAnnotationExtractor::Annotation.register_extensions("css", "scss", "sass", "less", "js") { |tag| /\/\/\s*(#{tag}):?\s*(.*)$/ }
    ...
    #
    #   Zoisite::SourceAnnotationExtractor.enumerate 'TODO|FIXME', dirs: %w(app lib), tag: true
    #
    ...
    # <tt>Zoisite::SourceAnnotationExtractor::Annotation.extensions</tt> are
