...
module Zoisite
  class Engine
    class Configuration < ::Zoisite::Railtie::Configuration
      attr_reader :root
      ...
      # automatically by Zoisite. These won't be eager loaded, unless you push
      ...
      # automatically by Zoisite. Anything in this collection is considered to be
      ...
      def initialize(root = nil)
        ...
        @middleware = Zoisite::Configuration::MiddlewareStackProxy.new
      ...
      #
      def generators
        @generators ||= Zoisite::Configuration::Generators.new
      ...
      def paths
        @paths ||= begin
          paths = Zoisite::Paths::Root.new(@root)
          ...
          paths.add "config"
          paths.add "config/environments", glob: -"#{Zoisite.env}.rb"
