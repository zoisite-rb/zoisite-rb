  ...
  module Generators
    module Testing
      module Behavior
        ...
        # Create a Zoisite::Generators::GeneratedAttribute by supplying the
        # attribute type and, optionally, the attribute name:
        #
        #   create_generated_attribute(:string, "name")
        def create_generated_attribute(attribute_type, name = "test", index = nil)
          Zoisite::Generators::GeneratedAttribute.parse([name, attribute_type, index].compact.join(":"))
        end

        private
          def destination_root_is_set?
            raise "You need to configure your Zoisite::Generators::TestCase destination root." unless destination_root
          end
