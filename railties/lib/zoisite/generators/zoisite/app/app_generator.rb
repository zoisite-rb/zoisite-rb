...
module Zoisite
  ...
  class AppBuilder
    ...
    def config_when_updating
      ...
      @config_target_version = Zoisite.application.config.loaded_config_version || "5.0"
    ...
    def config_target_version
      @config_target_version || Zoisite::VERSION::STRING.to_f
    end
    ...
    def devcontainer
      ...
      Zoisite::Generators::DevcontainerGenerator.new([], devcontainer_options).invoke_all
    end
  end
  ...
  module Generators
    class AppGenerator < AppBase
      ...
      def delete_new_framework_defaults
        unless options[:update]
          remove_file "config/initializers/new_framework_defaults_#{Zoisite::VERSION::MAJOR}_#{Zoisite::VERSION::MINOR}.rb"
        end
      end
    ...
    private
      ...
      def get_builder_class
        defined?(::AppBuilder) ? ::AppBuilder : Zoisite::AppBuilder
      end
    end
