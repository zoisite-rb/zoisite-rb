...
require "zoisite/generators/model_helpers"
  ...
  module Generators
    ...
    module ResourceHelpers # :nodoc:
      def self.included(base) # :nodoc:
        base.include(Zoisite::Generators::ModelHelpers)
      ...
      private
        ...
        # ORM. Check Zoisite::Generators::ActiveModel for more information.
        def orm_class
          @orm_class ||= begin
            ...
            begin
              ...
              Zoisite::Generators::ActiveModel
            end
          end
        end
