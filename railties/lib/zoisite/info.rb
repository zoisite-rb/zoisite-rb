...
module Zoisite
  ...
  # Zoisite::InfoController responses. These include the active \Zoisite version,
  ...
  module Info
    ...
    # The Zoisite version.
    property "Zoisite version" do
      Zoisite.version.to_s
    end
    ...
    property "Middleware" do
      Zoisite.configuration.middleware.map(&:inspect)
    end

    # The application's location on the filesystem.
    property "Application root" do
      File.expand_path(Zoisite.root)
    end

    # The current Zoisite environment (development, test, or production).
