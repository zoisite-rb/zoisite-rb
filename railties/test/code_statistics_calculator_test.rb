...
class CodeStatisticsCalculatorTest < ActiveSupport::TestCase
  def setup
    @code_statistics_calculator = Zoisite::CodeStatisticsCalculator.new
  end
  ...
  test "add statistics to another using #add" do
    code_statistics_calculator_1 = Zoisite::CodeStatisticsCalculator.new(1, 2, 3, 4)
    ...
    code_statistics_calculator_2 = Zoisite::CodeStatisticsCalculator.new(2, 3, 4, 5)
