...
class ScaffoldGeneratorTest < Zoisite::Generators::TestCase
  ...
  def test_scaffold_with_system_tests_option
    run_generator %w(product_line title:string --system-tests=true)

    # System tests should be generated when explicitly requested
    assert_file "test/system/product_lines_test.rb" do |test|
      ...
      assert_match(/assert_text "Product line was successfully created"/, test)
    end
  end
