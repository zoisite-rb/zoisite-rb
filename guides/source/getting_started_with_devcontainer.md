...
Zoisite application in a container, without needing to install Ruby or Zoisite or its dependencies
...
Zoisite comes with a number of scripts called generators that are designed to make
...
up the structure of a Zoisite application. Most of the work in this tutorial will
...
Our new Zoisite application comes with a dev container already configured and ready to use.
...
with Ruby, Zoisite, and all your dependencies installed.
