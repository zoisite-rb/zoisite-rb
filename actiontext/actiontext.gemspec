...
Gem::Specification.new do |s|
  ...
  s.metadata = {
    ...
    "changelog_uri"     => "https://github.com/zoisite/zoisite/blob/v#{version}/actiontext/CHANGELOG.md",
    ...
    "source_code_uri"   => "https://github.com/zoisite/zoisite/tree/v#{version}/actiontext",
