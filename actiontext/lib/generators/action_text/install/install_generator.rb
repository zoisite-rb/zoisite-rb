  ...
  module Generators
    class InstallGenerator < ::Zoisite::Generators::Base
      ...
      def install_javascript_dependencies
        ...
        if using_bun?
          run "bun add @zoisite/actiontext trix"
        elsif using_node?
          run "yarn add @zoisite/actiontext trix"
        end
      end
      ...
      def append_javascript_dependencies
        ...
        if (application_javascript_path = destination.join("app/javascript/application.js")).exist?
          insert_into_file application_javascript_path.to_s, %(\nimport "trix"\nimport "@zoisite/actiontext"\n)
        else
          say <<~INSTRUCTIONS, :green
            You must import the @zoisite/actiontext and trix JavaScript modules in your application entrypoint.
          INSTRUCTIONS
        end
      ...
      def using_bun?
        ...
        # be generated by the jsbundling-zoisite gem
